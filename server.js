    ...
    const App = {
        state: {
            ...
            data: { 
                ...
                bots: [], 
                pressels: [], 
                checkouts: [], // Adicionado estado para checkouts
                settings: {}, 
                transactions: [],
                dashboard: {}
            },
        ...
        addDashboardEventListeners() {
            document.addEventListener('click', async (e) => {
                ...
                // Listener para o novo botão de gerar código do checkout
            ...
            document.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    // Handler para o novo formulário de checkout
                        ...
                        if (pixel_ids.length === 0) {
                            ...
                            if (newCheckout) {
                                ...
                                this.navigateTo('checkouts'); // Recarrega a página para mostrar o novo item na lista
                                this.generateCheckoutHTML(newCheckout.id); // Abre o modal com o código
                            }
                        }
                    }
            ...
            // Listener para o seletor de tipo de valor no formulário de checkout
        ...
        renderTransactionsTable() {
            ...
            if (filteredTransactions.length > 0) {
                tableBody.innerHTML = filteredTransactions.map(t => {
                    ...
                    return `<tr class="hover:bg-slate-800/50"><td class="${statusColor}">${statusText}</td><td>${formattedValue}</td><td>${t.source_name}</td><td>${t.provider.toUpperCase()}</td><td>${formattedDate}</td></tr>`;
                }).join('');
            } else {
        ...
        // --- NOVA FUNÇÃO PARA GERAR O CÓDIGO HTML DO CHECKOUT ---
